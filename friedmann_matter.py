"""
Created on Fri Mar 4 13:40:08 2016

@author E. Saboya	/Users/Eric/Documents/hubble/friedmann_matter.py
...
init_y= [1, 0.7* 1e-24] #set the initial conditions (same as before)
...
init_x = [1, 1e-20] #set the initial conditions (same as before)
...
n = np.linspace(0,8,200)*s.pi
a_max = 0.5
a_matter= a_max*(1-np.cos(0.25*n))
t_matter = a_max*(n-np.sin(0.25*n))
...
ax.plot(t_matter*1e17,a_matter+1, color = 'blue', label = 'Closed Universe') #plot closed universe
