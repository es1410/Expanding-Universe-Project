...
@author: Eric	'/Users/Eric/Documents/hubble/friedmann_closed.py'
...
ax.plot(2*t_matter*1e17,a_matter+1, color = 'red', label = 'Matter-Dominated')
ax.plot(1.2*t_rad*1e17, 0.5*(a_rad)+1, color = 'green', label = 'Radiation-Dominated')
